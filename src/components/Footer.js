        ...
        <footer className="footer footer-expand-lg" id="mainFooter">
                <div className = "row m-5" >
                    <div className="col-md-3 mt-5">
                        <h4 className="title-h4 text-start"> John Doe </h4>
                    ...
                    <div className="col-md-3 mt-5">
                        <h4 className="title-h4 text-start"> Liens utiles </h4>
                        <ul className="list-styled text-start text-decoration-none "> 
                            <li><Link to="/accueil">Accueil</Link></li>
                            <li><Link to="/accueil">A propos</Link></li>
                            <li><Link to="/service">Services</Link></li>
                            <li><Link to="/service">Me contacter</Link></li>
                            <li><Link to="/mention">Mention</Link></li>
                        </ul>
                    </div>
                    <div className="col-md-3 mt-5">
                        <h4 className="title-h2 text-start"> Mes dernières réalisations </h4>
                        <ul className="list-styled text-start text-decoration-none"> 
                    ...
                    <div className="col-md-3 mt-5">
                        <h4 className="title-h4 text-start"> Mes derniers articles </h4>
                        <ul className="list-styled text-start text-decoration-none "> 
